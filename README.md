...
A program to demonstrate a recursive polygon subdivision algorithm as an interactive simulation and library. It features stop searching condition for subdivisions if it is out of bounding box. Supports division up to 16x16. With a one-line code modification, it is possible to divide even much more. The aim of this limitation is to use fixed memory that can be used in the future in C code.<br/>
